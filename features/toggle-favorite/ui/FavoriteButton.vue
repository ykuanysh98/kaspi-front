...
<template>
  <div
    ...
    :class="{ 'favorites-active': props.isFavorite }"
    @click.stop="toggleFavorite(props.productId)">
    <svg
      version="1.0"
      xmlns="http://www.w3.org/2000/svg"
      width="20pt"
      height="20pt"
      viewBox="0 0 228.000000 221.000000"
      ...
      <g
        ...
        stroke="none">
        <path
          d="M575 2085 c-227 -50 -398 -199 -483 -423 -24 -61 -26 -80 -26 -217 0
